...
function AeroplaneIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-8 w-8 drop-shadow-[0_6px_14px_rgba(255,255,255,0.24)]" aria-hidden>
      <path
        ...
        fill="currentColor"
      />
      <path d="M12 3.9v14.95" stroke="#0A1F5C" strokeOpacity="0.18" strokeWidth="0.7" strokeLinecap="round" />
    </svg>
  );
}
